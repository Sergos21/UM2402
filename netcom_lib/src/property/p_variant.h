...
* Проект: src.pro
*
* @file property/p_variant.h
*
* @brief: Заголовочный файл описания свойств для типов конвертируемых в
* QVariant (включая POD-типы)
*
* @note
*
* @author Лола С.А.
...
Q_OUTOFLINE_TEMPLATE bool INNER_PROPERTY_TEMPLATE_TYPE(T)::fromVariant(
  ...
  if (v.isValid() && !v.isNull()) {
    ValueType value = qvariant_cast<ValueType>(v);
